...
{
    std::cout <<"start HelloWorldPublisher::init";
    m_Hello.index(0);
    m_Hello.message("HelloDDS");
...
{
   //std::cout <<"HelloWorldPublisher::run" <<std::endl;
...
{
    // std::cout <<"HelloWorldPublisher::publish" <<std::endl;
    // std::cout <<"HelloWorldPublisher::m_listener.n_matched" << m_listener.n_matched <<std::endl;
